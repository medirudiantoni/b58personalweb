...
async function projectPost(req, res){
    const { name, start_date, end_date, description, nodeJS, nextJs, reactJs, typescript } = req.body;
    let node_js;
    let next_js;
    let react_js;
    let typeScript;
    ...
    try {
        ...
        await sequelize.query(query, {
            type: QueryTypes.INSERT,
            replacements: { name, start_date, end_date, description, node_js, next_js, react_js, typescript: typeScript, image_url }
        });
...
async function projectUpdate(req, res){
    const { id } = req.params;
    const { name, start_date, end_date, description, nodeJs, nextJs, reactJs, typescript, oldImage } = req.body;
    let node_js;
    let next_js;
    let react_js;
    let typeScript;
    ...
    try {
        ...
        await sequelize.query(query, {
            ...
            replacements: { name, start_date, end_date, description, node_js, next_js, react_js, typescript, image, id }
        });
